...
export default function Footer() {
    ...
    const openModal = (type) => {
        if (type === "privacy") {
            ...
            setModalData({ title: "Terms Of Use", body: TC });
        }
        setModalOpen(true);
    };
        ...
        <>
            <div className="full-footer">
                <div className="Footer-full">
                    ...
                    <div className="foot">
                        <button type="button" onClick={() => openModal("privacy")} className="link-btn">
                            Privacy Policy
                        </button>
                        <button type="button" onClick={() => openModal("refund")} className="link-btn">
                            Refund Policy
                        </button>
                        <button type="button" onClick={() => openModal("terms")} className="link-btn">
                            Terms Of Use
                        </button>
                    </div>
