...
import personImage2 from "../../image/Rectangle_14.png";
import personImage3 from "../../image/Rectangle_15.png";
import personImage4 from "../../image/Rectangle_16.png";
import personImage5 from "../../image/Rectangle_17.png";
// import personImage6 from "../../image/founder_1.png";
import personImage7 from "../../image/Rectangle_13.png";
import valuepic1 from "../../image/founder_1.png";
import valuepic2 from "../../image/management.png";
import valuepic3 from "../../image/accounts_1.png";
import valuepic4 from "../../image/payt_1.png";
import valuepic5 from "../../image/employeeAva.png";
...
const ValueComponent = () => {
    ...
    const roles = useMemo(() => [
        ...
        { name: "Payroll Team", img: valuepic4 },
        { name: "Management", img: valuepic2 },
        { name: "Accounts", img: valuepic3 },
        { name: "Employee", img: valuepic5 },
    ], []);
    ...
    return (
        <div className="value-container">
            ...
            {selectedRole === "Founder" && (
              ...
              <div className="founder-container">
                <div className="cards-wrapper">
                    ...
                    <h3 className="grey-heading">Without SalaryBooks</h3>
                    <ul>
                    ...
                    <h3 className="blue-heading">With SalaryBooks</h3>
                    <ul>
                ...
                <div className="image-container">
                    <img src={personImage7} alt="Founder" />
                </div>
                </div>
            ...
            {selectedRole === "Accounts" && (
                ...
                <div className="image-container">
                    <img src={personImage3} alt="Accounts" />
                </div>
                </div>
            )}

            {selectedRole === "Payroll Team" && (
                // <div className="value-container">
                //     <div className="content-container">
                //        <div className="left-section">
                //             <div className="info-box blue-box">
                //                 <div className="box-header text-center">SalaryBooks waale</div>
                //                 <ul>
                //                         <li><span className="list-bold">Automation Does the Hard Work</span> – The system handles complex payroll processing so the team can focus on review and approval.</li>
                //                         <li><span className="list-bold">Effortless Attendance Tracking</span> – Automatic integration with biometric systems ensures precise, real-time attendance data.</li>
                //                         <li><span className="list-bold">No More Spreadsheet Chaos</span> – Eliminate dependency on Excel and centralize all payroll operations in one reliable platform.</li>
                //                         <li><span className="list-bold">Error-Free Calculations</span> – Built-in checks drastically cut manual mistakes, protecting accuracy and compliance.</li>
                //                         <li><span className="list-bold">No More Repetitive Work</span> – Routine tasks are automated, freeing up time for higher-value activities.</li>
                //                 </ul>
                ...
                <div className="image-container">
                    <img src={personImage2} alt="Payroll Team" />
                </div>
                </div>
            )}
